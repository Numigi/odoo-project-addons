...
class TestReport(common.SavepointCase):
    ...
    def test_amounts(self):
        ...
        assert lines[1]["total_estimated_hours"] == self.lot.total_estimated_hours
        assert (
            lines[1]["budget_remaining"]
    ...
    def _get_lines(self):
        return self.report.get_rendering_variables(self.parent_project)["lines"]
