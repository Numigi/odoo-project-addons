...
COPY root_analytic_account_project /mnt/extra-addons/root_analytic_account_project
COPY root_analytic_account_timesheet /mnt/extra-addons/root_analytic_account_timesheet
