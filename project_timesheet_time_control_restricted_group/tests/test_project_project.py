...
class TestProject(common.SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.timesheet_user_group = cls.env.ref("hr_timesheet.group_hr_timesheet_user")
    ...
    def test_demo_user_has_restricted_access_to_launch_timer(self):
        ...
        self.assertTrue(
            has_restricted_group,
            "`demo` user should belong to the restricted " "group before the test",
        )
    ...
    def test_restricted_access_to_launch_timer_in_project_form_view(self):
        ...
        self.assertEquals(
            field_node[0].attrib.get("invisible"),
            "1",
            "The button 'button_start_work' mustn't be found " "in project form view",
        )
    ...
    def test_restricted_access_to_launch_timer_in_project_kanban_view(self):
        ...
        self.assertEquals(
            field_node,
            [],
            "The button 'button_start_work' mustn't be found " "in project kanban view",
        )
    ...
    def test_restricted_access_to_launch_timer_in_project_list_view(self):
        ...
        self.assertEquals(
            field_node[0].attrib.get("invisible"),
            "1",
            "The button 'button_start_work' mustn't be found " "in project list view",
        )
    ...
    def test_restricted_access_to_launch_timer_in_task_list_view(self):
        ...
        self.assertEquals(
            field_node[0].attrib.get("invisible"),
            "1",
            "The button 'button_start_work' mustn't be found " "in task list view",
        )
    ...
    def test_restricted_access_to_launch_timer_in_task_form_view(self):
        ...
        self.assertEquals(
            field_node[0].attrib.get("invisible"),
            "1",
            "The button 'button_start_work' mustn't be found " "in task form view",
        )
    ...
    def test_restricted_access_to_launch_timer_in_task_kanban_view(self):
        ...
        self.assertNotEquals(
            field_node,
            [],
            "The button 'button_start_work' must be found " "in task kanban view",
        )
