...
#         cls.referenced_task = cls.env["project.task"].create(
#             {"name": "Some Referenced Task"}
#         )
...
#         cls.referenced_task_2 = cls.env["project.task"].create(
...
#             "project_task_reference.format", ref_format
#         )
